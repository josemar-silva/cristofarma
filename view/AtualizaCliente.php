...
<body>
    ...
    {   
        ...
        
        {
            ...
            header("location: ConsultaClientes.php?buscaCliente=$nome");
    ...
    <section id="principal">
        ...
        <form id="cadastro" method="POST">
            ...
            <select id="tipoCadastro" class="form-control" name="tipoCadastro" onchange="verifica(this.value)">
                ...
                <option value="cliente" <?php if ($retornoTipoPessoa == 'fornecedor'){echo 'selected';}?>>Fornecedor</option>
                <option value="cliente" <?php if ($retornoTipoPessoa == 'funcionario'){echo 'selected';}?>>Funcionário</option>
            </select><br/>
            ...
            <input id="cpfAndCnpj" class="form-control" type="text" name="cpf_cnpj" size="20" value="<?php if(isset($retornoConsulta)){echo $retornoConsulta[0]['cpf_cnpj'];}?>"><br/><br/>
            ...
            <input id="telefoneFixo" class="form-control" type="text" name="telefoneFixo" size="22" value="<?php if(isset($retornoConsulta)){echo $retornoConsulta[0]['telefone_fixo'];}?>">&nbsp; &nbsp;

            <input id="telefoneCelular" class="form-control" type="text" name="telefoneCelular" required size="22"  style="margin-left: 15%;" value="<?php if(isset($retornoConsulta)){echo $retornoConsulta[0]['telefone_celular'];}?>"><br/><br/>

            

            <label for="endereco" id="endereco">Endereço:</label><br>
            <input id="endereco" class="form-control"type="text" name="endereco" size="70" 
