...
>>>>>>> aeeee11cc7aea39362bb1ad2c340d0b838dacab7
    ...
    <form id="cadastro" method="POST">
      ...
      <label for="nome" id="nome">Nome:</label><br />
      <input id="nome" type="text" class="form-control" name="nome" size="40" required value="<?php if (isset($retornoConsulta)) {
                                                                                                echo $retornoConsulta[0]['nome'];
                                                                                              } ?>"><br /><br />

      <label for="cpfAndCnpj" id="cpf">CPF/CNPJ:</label><br />
      <input id="cpfAndCnpj" class="form-control" type="text" name="cpf_cnpj" size="20" maxlength="14" value="<?php if (isset($retornoConsulta)) {
                                                                                                                echo $retornoConsulta[0]['cpf_cnpj'];
                                                                                                              } ?>"><br /><br />

      <label for="email" id="email">E-mail:</label><br />
      <input id="email" class="form-control" type="email" name="email" size="50" required value="<?php if (isset($retornoConsulta)) {
      ...
      <input id="telefoneFixo" class="form-control" type="text" name="telefoneFixo" data-mask="(00) 0000-0000" data-mask-selectonfocus="true" size="20 value=" <?php if (isset($retornoConsulta)) {
                                                                                                                                                                  echo $retornoConsulta[0]['telefone_fixo'];
                                                                                                                                                                } ?>">&nbsp; &nbsp;

      <input id="telefoneCelular" class="form-control" type="text" name="telefoneCelular" data-mask="(00) 00000-0000" data-mask-selectonfocus="true" size="20" required style="margin-left: 16%;" value="<?php if (isset($retornoConsulta)) {
      ...
      <input class="btn btn-outline-danger" id="btnCadastrar" type="submit" name="btnGravarClientes" style="margin-left: 40%; margin-top: 3%;" value="<?php if (isset($_GET['id_get_up'])) {
                                                                                                                                                        echo 'Atualizar';
                                                                                                                                                      } else {
                                                                                                                                                        echo 'Cadastrar';
                                                                                                                                                      } ?>">
