...
<body>
    ...
    <section id="principal">
        ...
        <form id="cadastro" method="POST">
            ...
            <input id="cpfAndCnpj" class="form-control" type="text" name="cpf_cnpj" size="22" value="<?php if(isset($retornoConsulta)){echo $retornoConsulta[0]['cpf_cnpj'];}?>"><br/><br/>
            ...
            <input id="telefoneCelular" class="form-control" type="text" name="telefoneCelular" size="20"  style="margin-left: 15%;" value="<?php if(isset($retornoConsulta)){echo $retornoConsulta[0]['telefone_celular'];}?>"><br/><br/>
