...
<body>
  ...
  <section id="principal">
    <form id="cadastro" method="POST">
      ...
      <input id="fornecedor" class="form-control" type="text" type="text" autofocus required name="fornecedor" size="25" value="<?php if (isset($_GET['id_fornecedor_produto_get_up'])) {
      ...
      <input class="btn btn-outline-danger" type="submit" id="btnCadastrar" name="btnGravarClientes" style="margin-left: 40%; margin-top: 5%;" value="<?php echo "Cadastrar"; ?>">
    </form>
  </section>
</body>
