    ...
    <div class="tableFixHead">
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          ?>
                <td>
                  <a class="" id="acaoSelecionar" href="Vendas.php?id_produto_up_venda=<?php echo $dados[$i]['id_produto']; ?>"><i class="fas fa-hand-pointer"></i>
                    <!--Selecionar-->
                  </a>
                  <a class="acaoVerde my-2" id="acaoEditar" href="AtualizaProduto.php?id_get_up=<?php echo $dados[$i]['id_produto']; ?>"><i class="fas fa-edit"></i>
                    <!--Editar-->
                  </a>
                  <a class="acaoVermelho my-2" id="acaoExcluir" href="ConsultaProdutos.php?id_get_del=<?php echo $dados[$i]['id_produto']; ?>"><i class="fas fa-trash"></i>
                    <!--Excluir-->
                  </a>
            ...
            if (isset($_GET['buscaProduto'])) {
              ...
              if (count($dados) > 0) {
                ...
                ?>
                  <td>
                    <a class="" id="acaoSelecionar" href="AlimentarEstoque.php?id_produto_up_estoque=<?php echo $dados[$i]['id_produto']; ?>"><i class="fas fa-hand-pointer"></i>
                      <!--Selecionar-->
                    </a>
                  </td>
          <?php
