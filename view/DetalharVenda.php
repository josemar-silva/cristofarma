...
<body>
    ...
    ?><br>
        ...
        <legend style="color: white; float: left; font-size: 13pt; margin-top: -2%; color: blue;"> VENDA Nº  <input id="saidaIdVendaFecharCaixa" size="8"
        value="<?php echo $codigo_venda_return;?>" style=" color: red; text-align: center; margin-top: -30%; border: none; 
