...
<body>
    ...
    <section id="principal">
        ...
        <form id="cadastro" method="POST">
            ...
            <label id="txtTipoCadastro">Tipo de cadastro:</label> <span> <?php if(isset($retornoConsulta)){
                ...
                $retornoFuncao = $retornoConsulta[0]['funcao'];}?></span>
            ...
            <input id="matricula" class="form-control" type="text" name="matricula" size="60" value="<?php if(isset($retornoConsulta)){if (isset($retornoConsulta[0]['matricula'])){ echo $retornoConsulta[0]['matricula'];} else { echo '';}}?>" >

            <label for="senha">Senha:</label>
            <input id="senha" class="form-control" type="password" name="senha" size="60" value="" disabled>
    ...
    <script>
        ...
        if(value == "funcionario"){
            ...
            <input id="endereco" class="form-control" type="text" name="endereco" size="60" value="<?php if(isset($retornoConsulta)){echo $retornoConsulta[0]['endereco'];}?>" >
